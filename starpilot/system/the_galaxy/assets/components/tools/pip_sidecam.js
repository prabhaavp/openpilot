    ...
    <div class="v-asm-wrapper">
      <div class="v-asm-section">
        ...
        <div class="v-asm-note">
          Use the preview to glance at the adjacent lane before merging. Always check before merging and be aware the driver camera view is from the cabin.
        </div>
        ...
        ${state.configSaved ? html`
          <div class="v-asm-success-banner">
            PiP Preview mask saved! Configure the preview in <a href="/device_settings/blind-spot-monitoring">Toggles</a>.
          </div>
        ` : ""}
      ...
      <div class="v-asm-card v-asm-card-warning">
        ...
        <ul class="v-asm-card-list">
          <li>Enable "PiP Preview" in <a href="/device_settings/blind-spot-monitoring">Toggles -> Blind Spot Monitoring</a></li>

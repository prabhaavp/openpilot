...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"LeadSmoothingFactor", {PERSISTENT, FLOAT, "0", "0", 1}},
    ...
    {"ManualCurveSpeed", {PERSISTENT, FLOAT, "2.0", "2.0", 1}},
    ...
    {"PathSmoothingFactor", {PERSISTENT, FLOAT, "35", "0", 1}},
    {"MinPathSpeed", {PERSISTENT, INT, "0", "0", 1}},
    ...
    {"UseManualCurveSpeed", {PERSISTENT, BOOL, "0", "0", 1}},
    {"UseRaylibUI", {PERSISTENT, BOOL, "0", "0", 1}},

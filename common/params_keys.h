...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"ManualCurveSpeed", {PERSISTENT, FLOAT, "2.0", "2.0", 1, SETTINGS_SIMPLE}},
    ...
    {"MinPathSpeed", {PERSISTENT, BOOL, "0", "0", 1, SETTINGS_SIMPLE}},
    ...
    {"PathSmoothingFactor", {PERSISTENT, FLOAT, "0", "0", 1, SETTINGS_SIMPLE}},
    ...
    {"PIPPreviewMask", {PERSISTENT, JSON, "{}", "{}", 2}},
    ...
    {"UseManualCurveSpeed", {PERSISTENT, BOOL, "0", "0", 1, SETTINGS_SIMPLE}},
